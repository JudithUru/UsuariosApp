...
public class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerUsuarios.setOnClickListener(v ->{
            startActivity(new Intent(MainActivity1.this, MainActivity2.class)); //la miss en vez de poner activity_main puso MainActivity y en la lista puso ListaUsuarios
        });
    }
